...
public actual fun interface PlatformConsumer<T> {
    public actual fun accept(t: T)
}

public actual fun interface PlatformFunction<T, R> {
    public actual fun apply(t: T): R
}

public actual fun interface PlatformRunnable {
    public actual fun run()
}

public actual fun interface PlatformSupplier<T> {
